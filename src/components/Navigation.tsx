      ...
      <div className="lg:hidden">
        ...
        <div className="fixed top-0 left-0 right-0 h-16 bg-card border-b shadow-card z-50 flex items-center justify-between px-4">
          ...
          <Button
            ...
            className="relative z-10 mt-24 h-12 w-12 rounded-xl border-2 border-primary/30 bg-gradient-to-br from-primary/15 to-primary/5 hover:border-primary/50 hover:from-primary/25 hover:to-primary/10 transition-all duration-300 shadow-md hover:shadow-lg active:scale-95"
