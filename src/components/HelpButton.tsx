...
import { HelpCircle, BookOpen, Send, CheckCircle2 } from 'lucide-react';
...
const HelpButton = React.memo(() => {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      const validated = ticketSchema.parse(formData);
      setLoading(true);
      ...
      toast({
        ...
        description: `Your ticket ${data.ticket_number} has been created successfully.`,
      });
    } catch (error) {
