-- First, delete any students with NULL institution_id (orphaned records)
DELETE FROM students WHERE institution_id IS NULL;
...
-- 4. Add index for better query performance with isolation
