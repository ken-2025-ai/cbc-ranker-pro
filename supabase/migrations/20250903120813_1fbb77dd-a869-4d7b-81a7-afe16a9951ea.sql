-- Create missing core tables for CBC Academic System

-- 1. Fees table - currently missing but referenced in payments
...
-- 6. Student disciplinary records
